...
// })
// app.use(limiter)
app.get('/png', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const setDomainLocalStorage = (browser, url, localStorageValues, cookiesValues) => __awaiter(void 0, void 0, void 0, function* () {
        const page = yield browser.newPage();
        yield page.setRequestInterception(true);
        page.on('request', r => r.respond({ status: 200, contentType: 'text/plain', body: 'tweak me.', }));
        yield page.goto(url);
        yield page.evaluate(values => {
            for (const key in values) {
                window.localStorage.setItem(key, values[key]);
            }
        }, localStorageValues);
        yield page.setCookie(...cookiesValues);
        yield page.close();
    });
    const getScreenshot = (url, localStorageValues, cookiesValues) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            return yield page.screenshot({ type: 'png', clip: { x: 367, y: 107, width: 717.1875, height: 334.34375 } });
        }
        catch (e) {
            console.error(e);
        }
    ...
    const { data, headers } = yield axios_1.default.post(auth, body);
    // console.log(data, headers)
    const setCookie = headers['set-cookie'];
    const unSession = ((_b = (_a = setCookie[0]) === null || _a === void 0 ? void 0 : _a.split(';')[0]) === null || _b === void 0 ? void 0 : _b.split('=')[1]) || '';
    ...
    try {
        ...
        const picture = yield getScreenshot(main, localStorageValues, cookiesValues);
